  ...
  const [faqs, setfaqs] = useState([
    {
      ...
      answer: 'Es una red de personas que comparten viajes en auto entre ciudades, haciendo una división equitativa de costos entre todos los viajeros o una contribución convenida. Friendly Travel no es un sistema de transporte de pasajeros ni público ni privado. Es un proyecto de gestión colectiva.',
      open: false
    },
    {
